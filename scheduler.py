...
class ModelProfile:
    ...
    best_for: List[str]   # ["coding", "analysis", "creative", "reasoning"]
...
class FleetScheduler:
    """Schedule the right model at the right time."""
    ...
    def _setup_default_schedule(self):
        """Default schedule optimized for cost."""
        self.schedule = [
    ...
    def complete_task(self, task_id: str, actual_tokens: int):
